                ...
                <Fade left>
                  ...
                  <FormControl variant="outlined" fullWidth>
                    ...
                    <h2>
                     ...
                     <body>
                     The Wilmeth Active Learning Center contains 4 floors (1 basement, 1 at grade, and 2 above grade); major uses are libraries, instruction, cafe and administration.<br></br>
                     The Building has 4 entrances: - 1 on the North West end; 1 on the South West end; 1 on the North East end; 1 on the North West end.<br></br>
                     </body>
                     <br></br>
                     <h2>
                     Evacuation Areas
                     ...
                     <body>
                     <b>Primary location:</b><br></br>Please gather at the southeast corner of Potter Engineering Center (POTR)<br></br>
                     <b>Secondary location:</b><br></br>In case of inclement weather, please gather in the lounge inside the Southeast corner of Potter Engineering Center (POTR).
                  </body>
                  </FormControl>
                </Fade>
              </Box>
